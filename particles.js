...
var pJS = function(tag_id, params) {
  var canvas_el = params.canvas
    ? params.canvas.el
    : document.querySelector('#' + tag_id + ' > .particles-js-canvas-el');
  ...
  pJS.fn.updateParams = function(params) {
    Object.deepExtend(pJS, params);
    // regen tmp obj?
    pJS.tmp.obj = {
      size_value: pJS.particles.size.value,
...
window.particlesJSWithCanvas = function(canvas, params) {
  params.canvas = {
    el: canvas,
